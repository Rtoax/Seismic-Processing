...
//a#####################################################
//a##
//a##  myRungeKuttaRayTracingAboutDialog to myJMenuBar
//a##
//a#####################################################
/**
 * 
 ...
 *    Modify by: Rong Tao
 */
public class myRungeKuttaRayTracingAboutDialog extends JDialog {

    private Toolkit toolkit;

    private int itext =0 ;

    public myRungeKuttaRayTracingAboutDialog() {
        ...
        JLabel hint = new JLabel("About RungeKutta RayTracing");
        hint.setBorder(BorderFactory.createEmptyBorder(0, 25, 0, 0));
        topPanel.add(hint);

        ImageIcon icon = new ImageIcon("picture/ButtonImg/traytracingRK32.png");
        ...
        final String[] text ={ "<p><b>About The RungeKuttaTracing</b></p>" +
                "<p>. Author: Rong Tao</p>" +
                "<p>. Time: 2017.8 </p>"+
                ...
                "<p><b></b></p>" +
                "<p>.   You just change the velocity,epsilon,delta,</p>" +
                "<p>. or use constant paras.  </p>"+
