...
//a#################################
//a##
//a##  myXmovie2OrderAbsAboutDialog to myJMenuBar
//a##
//a#################################
/**
 * 
 ...
 *    Modify by: Rong Tao
 */
public class myXmovie2OrderAbsAboutDialog extends JDialog {

    private Toolkit toolkit;

    private int itext =0 ;

    public myXmovie2OrderAbsAboutDialog() {
        ...
        ImageIcon icon = new ImageIcon("picture/ButtonImg/tmovie2order32.png");
        ...
        final String[] text ={ "<p><b>About The Tmovie2order</b></p>" +
                "<p>. Author: Rong Tao</p>" +
                "<p>. Time: 2017.7 </p>"+
                ...
                "<p><b>Function</b></p>" +
                "<p>.d^2P/dt^2 = Vpx^2*d^2P/dx^2</p>" +
                "<p>.------------ + Vp0^2*d^2Q/dz^2</p>"+
                "<p>.d^2Q/dt^2 = Vpn^2*d^2P/dx^2 "+
                "<p>.------------ + Vp0^2*d^2Q/dz^2</p>"+
                "<p>.------Vpx^2=Vp0^2*(1+2epsilon)</p>"+
                "<p>.------Vpn^2=Vp0^2*(1+2delta)</p>",
