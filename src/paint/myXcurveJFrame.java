 ...
 *    Modify by: Rong Tao
 */
public class myXcurveJFrame extends JFrame{
    ...
    public myXcurveJFrame(int n, String txtfile, int linewidth, int linecolor){
        ...
        /* xcurve show panel in xcurveJFrame */
        myxcurveJPanel = new myXcurveJPanel(n,txtfile, linewidth, linecolor);
        ...
        JMenuItemSaveSave.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                saveJPanel.saveImage(myxcurveJPanel, JMenuSave);
                  }
           });
