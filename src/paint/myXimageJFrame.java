 ...
 *    Modify by: Rong Tao
 */
public class myXimageJFrame extends JFrame{
    ...
    public myXimageJFrame(int nx,int xbeg, int ny, String filename, String title
        ...
        myximageJPanel = new myXimageJPanel(nx,xbeg,ny
                           ,getWidth()-40,getHeight()-40,filename
                           ,minX, minZ, maxX, maxZ);
        ...
        JMenuItemSaveSave.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                saveJPanel.saveImage(myximageJPanel, JMenuSave);
                  }
           });
